...
from model.Models import get_unet_inception_res_sen_dense
input_size = 1024
...
model_factory = get_unet_inception_res_sen_dense(input_shape = (1024,1024,3), pool_size=(2, 2), n_calsses=1, depth=4, n_base_filters=32)
