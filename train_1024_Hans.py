    ...
    while True:
        for start in range(0, len(ids_train_split), batch_size):
            ...
            for id in ids_train_batch.values:
                ...
                img, mask,mask_mean = randomShiftScaleRotate(img, mask,mask_mean,
                                                   shift_limit=(-0.0625, 0.0625),
                                                   scale_limit=(-0.1, 0.1),
                                                   rotate_limit=(-0, 0))
...
callbacks = [EarlyStopping(monitor='val_loss',
             ...
             ModelCheckpoint(monitor='val_loss',
                             filepath='weights/best_weights_with_dropout.hdf5',
                             save_best_only=True,
                             save_weights_only=True),
             TensorBoard(log_dir='logs')]
try:
    model.summary()
    model.load_weights('best_weights_with_dropout.hdf5')
except:
    pass
